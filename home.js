...
// CODE HERE
const canWeDeliverTwo = (zipCode) => deliveryAreaZipCodes.includes(zipCode) ? `You are in our delivery zone!` : `Sorry, we can't deliver to that address`
console.log(canWeDeliverTwo(85286));
